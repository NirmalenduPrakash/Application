...
from common.vl_adapter_bert import VisualLinguisticBert
...
class ResNetVLBERTv3(Module):
    def __init__(self, config):
        ...
        language_pretrained_model_path = '/scratch/users/sutd/nirmalen/HatefulMemesChallenge-main/VL-BERT/pretrain_model/vl-bert/bert-base-uncased/pytorch_model.bin'
