...
class BrioDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        tgt = self.tok.batch_encode_plus(tgt_txt, max_length=self.maxlen, return_tensors="pt", pad_to_max_length=False, truncation=True, padding=True)
        tgt_ids = tgt["input_ids"].squeeze()
        result = {
